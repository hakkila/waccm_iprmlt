...
contains
  ...
  subroutine setext( extfrc, zint_abs, zint_rel, cldtop, &
    ...
    use mo_iprmlt,      only : iprmlt_ionization_noxhox
    ...
    real(r8) :: iprmlt_nox(ncol,pver)     ! Medium energy electrons NO production
    real(r8) :: iprmlt_hox(ncol,pver)     ! Medium energy electrons HOx production
...
!    endif
    ...
    call iprmlt_ionization_noxhox( ncol, lchnk, zmid, pmid, tfld, iprmlt_nox, iprmlt_hox )
    ...
    epp_ipr(:ncol,:pver) = epp_ipr(:ncol,:) + gcr_ipr(:ncol,:) + iprmlt_nox(:ncol,:) ! TH: This should work
